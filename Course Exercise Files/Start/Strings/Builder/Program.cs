...
{
    /// <summary>
    /// String builder is an efficient way of working with string.
    /// If code needs a lot of string concat & manipulation
    /// </summary>
    class Program
    {
        static void Main(string[] args)
        {
            ...
            sb.AppendFormat("He did this {0} number of times ", jumpCount);
